...
const leadFields = {
  ...
  company_name: z
    .string()
    .optional()
    .describe("Name of the company the lead comes from"),
  status: z.string().optional().describe("The status of the lead"),
  quality: z.string().optional().describe("Star scoring for the lead"),
  value: z
    .string()
    .optional()
    .describe("Decimal representing the monetary value of the lead"),
  wants_newsletter: z
    .boolean()
    .optional()
    .describe("Whether the lead wants to receive the newsletter"),
  administrator_id: z
    .number()
    .int()
    .positive()
    .optional()
    .describe("ID of the administrator that owns the lead"),
  account_id: z
    .number()
    .int()
    .positive()
    .optional()
    .describe("ID of the account linked to this lead"),
  user_id: z
    .number()
    .int()
    .positive()
    .optional()
    .describe("ID of the user linked to this lead"),
};
  ...
  server.tool(
    ...
    "Get all lead records",
    {
      ...
      sort: z
        ...
        .optional()
        .describe(
          "Sort results. Each value can be a field name or field:asc / field:desc",
        ),
      include: z
        .array(z.string())
        .optional()
      ...
      search: z
        .string()
        .optional()
        .describe("Filter results by a search string"),
      status: z
        .array(z.string())
        .optional()
      ...
      course_id: z
        .array(z.string())
        .optional()
        .describe("Filter results by course ID"),
      planned_course_id: z
        .array(z.string())
        .optional()
        .describe("Filter results by planned course ID"),
      administrator_id: z
        .array(z.string())
        .optional()
        .describe("Filter results by administrator ID"),
      label_id: z
        .array(z.string())
        .optional()
        .describe("Filter results by label ID"),
      user_id: z
        .array(z.string())
        .optional()
        .describe("Filter results by user ID"),
      account_id: z
        .array(z.string())
        .optional()
        .describe("Filter results by account ID"),
    },
    async ({
      cursor,
      per_page,
